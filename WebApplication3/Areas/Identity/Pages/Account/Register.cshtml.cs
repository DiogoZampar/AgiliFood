    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                String[] roles = {"Funcionario", "Financeiro", "Fornecedor"};
                if (roles.Contains(Input.Tipo))
                {
                    if (Input.Tipo.Equals("Fornecedor"))
                    {
                        await _userManager.AddToRolesAsync(user, (IEnumerable<string>)new[] { "FornecedorAtivo", "Fornecedor" });
                    }
                    else
                    {
